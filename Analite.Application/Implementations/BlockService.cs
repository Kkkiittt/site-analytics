...
public class BlockService : IBlockService
{
	...
	private readonly ILogger<BlockService> _log;
	...
	{
		_log.LogInformation("User {UserId} attempts to create a block on Page {PageId}",
			_id.Id, 
			dto.PageId);
	...
	{
		_log.LogInformation("User {UserId} attempts to delete Block {BlockId}",
			_id.Id,
			id);
	...
	{
		_log.LogInformation(
			"User {UserId} attempts to update Block {BlockId}",
			_id.Id,
			id);
